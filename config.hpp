...
#define CONFIG_HPP	1
  ...
  // ===== ACCESS POINT ===== //
  #ifndef AP_SSID
    #define AP_SSID "ESP8266_Dev-Board"
  #endif /* ifndef AP_SSID */

  #ifndef AP_PASSWD
    #define AP_PASSWD "Default_123"
  ...
  #define DEV_BOARD_VERSION "2.6.0"
  #define DEV_BOARD_VERSION_MAJOR 2
  #define DEV_BOARD_VERSION_MINOR 6
  #define DEV_BOARD_VERSION_REVISION 0
  ...
  #define MIN_DEAUTH_FRAMES 3
    ...
    // ===== ACCESS POINT ===== //
  #define AP_SSID "Watch This WiFi!"
  #define AP_PASSWD "Toonarmy-1992"
  #define AP_HIDDEN false
  #define AP_IP_ADDR {192, 168, 4, 1}
