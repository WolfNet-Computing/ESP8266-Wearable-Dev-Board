...
Else
{
	...
	# The '$downloads' array follows the pattern:
	#	$downloads = @(
	#		"[Repository URL 1]/archive/refs/heads/main.zip",
	#		"[Repository URL 2]/archive/refs/heads/master.zip",
	#		"[Repository URL 3]/archive/refs/tags/[Version Tag].zip",
	#		...
	#	)
	$downloads = @(
...
#		"https://github.com/ThingPulse/esp8266-oled-ssd1306/archive/refs/tags/4.0.0.zip",
...
#		"https://github.com/WolfNet-Computing/ESP8266RFCTelnet/archive/refs/heads/master.zip",
		"https://github.com/me-no-dev/ESPAsyncUDP/archive/refs/heads/master.zip",
		...
		"https://github.com/sstaub/NTP/archive/refs/heads/main.zip"
	)
